...
module.exports = function (grunt) {
  ...
  grunt.registerTask('build', ['clean','html2js','concat','less:development','copy:assets']);
  grunt.registerTask('release', ['clean','html2js','uglify','jshint','concat:index', 'less','copy:assets']);
